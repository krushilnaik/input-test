...
const ProjectSummaryRenderer = ({
	content,
	projectId,
}: ProjectSummaryRendererProps) => {
	// Always show skeleton loader
	return (
		<div className="w-full">
			{/* Gradient border wrapper */}
			<div className="glass relative rounded-xl bg-linear-to-r from-pink-500 via-orange-400 to-orange-500 p-[1px]">
