...
import GrowthKPIRenderer from "./others/GrowthKPIRenderer";
import HeadlineRenderer from "./others/HeadlineRenderer";
import ImageRenderer from "./others/ImageRenderer";
import ImageSectionRenderer from "./others/ImageSectionRenderer";
import JiraPromptRenderer from "./others/JiraPromptRenderer";
import KPIRenderer from "./others/KPIRenderer";
import ProjectStartCTARenderer from "./others/ProjectStartCTARenderer";
import ProjectSummaryRenderer from "./others/ProjectSummaryRenderer";
import SectionRenderer from "./others/SectionRenderer";
import StatusRenderer from "./others/StatusRenderer";
...
export const components: ExtendedComponents = {
	...
	choroplethchart: (props: ChartProps) => (
		<ChartRenderer {...props} type="choropleth" />
	),
	scatterchart: (props: ChartProps) => (
		<ChartRenderer {...props} type="scatter" />
	),
